...
def login_request(request):
    context = {}
    url = "https://722b0a8f.eu-gb.apigw.appdomain.cloud/capstone/api/dealership"
...
def get_dealerships(request):
    if request.method == "GET":
        context={}
        url = "https://722b0a8f.eu-gb.apigw.appdomain.cloud/capstone/api/dealership"
        apikey="SzJ5tNAzMZS3OpYTLkzOAxaBU-0lckN8L-4WF9EFmAT2"
...
def get_dealer_details(request, dealer_id):
    context={}
    url = "https://722b0a8f.eu-gb.apigw.appdomain.cloud/capstone/api/review"
    apikey="SzJ5tNAzMZS3OpYTLkzOAxaBU-0lckN8L-4WF9EFmAT2"
    #print(dealer_id)
    # Get dealers from the URL
...
def add_review(request, dealer_id):
    ...
    if request.method == 'GET':
        ...
        if (request.user.is_authenticated):
            ...
            json_result = post_request("https://722b0a8f.eu-gb.apigw.appdomain.cloud/capstone/api/review", review, dealerId=dealer_id)
            print(json_result)
